...
class FlowNetC(nn.Module):
    def __init__(self,args, batchNorm=False, div_flow = 20):
        ...
        # loaded = torch.load('/data2/liuziyang/HDR/HDR_Ghost_Removal/RAFT-master/checkpoints/flownetc-hdr-imf-short2long-fullloss-smooth0.01-newdata-occ.pth', map_location='cpu')
    ...
    def forward(self, x, training=True, test=False):
